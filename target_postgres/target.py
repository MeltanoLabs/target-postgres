    ...
    config_jsonschema = th.PropertiesList(
        ...
        th.Property(
            ...
            description=(
                ...
                + "dialect, and all ssl settings. It is strongly recommended the "
                + "driver is compatible with psycopg3. Note that you must escape "
                + "password special characters properly. See "
